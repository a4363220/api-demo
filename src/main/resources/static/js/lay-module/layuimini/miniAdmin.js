    ...
    var miniAdmin = {
        ...
        render: function (options) {
            ...
            options.customAjax.ajax(options.customAjax.queryAdminMenuByAdminUserTypeUrl, "get", queryAllData, function (r) {
                ...
                options.customAjax.verifyRespCode(respCode, respMsg);
                if (respCode != "0000") {
                    return;
                }
                var respData = r.respData;
                // 思来想去,还是不改变原前端框架的数值,将后台返回的参数在前端转换
                var logoInfo = {"image": "images/logo.png", "href": "javascript:;"};
                var homeInfo = {"href": "page/welcome.html", "title": "首页"};
                // 重组菜单
                var moduleMenuList = options.customCommon.regroupAdminMenu(respData);
